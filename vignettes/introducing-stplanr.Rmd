...
The best available evidence suggests that the future of civilisation depends on our ability to transition away from fossile fuels, and transport is a major roadblock preventing decarbonisation, as the fastest growing sector by energy use. It is this knowledge that motivated the word 'sustainable' in the package's name: by focussing on active travel, we hope it is used as part of this global transition away from fossil fuels. 
...
series of tools and example datasets. 
